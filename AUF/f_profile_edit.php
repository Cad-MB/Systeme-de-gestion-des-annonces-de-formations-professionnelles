...
<!---------------------------------   Input Form ( Change Password )  ---------------------------->
      ...
      <form method="post" action="f_profile_edit.php" >
  ...
  {              
    ...
    $sql = "SELECT password FROM formateur_signup WHERE username='$use'"; 
     ...
     while ($row = mysqli_fetch_array($result)) 
    {
           ...
           if($pass == $oldpass)
          {
             ...
             if($newpassword == $confirmnewpassword)
            {
              ...
              $up ="UPDATE formateur_signup SET password='$confirmnewpassword' WHERE username='$use'";
               ...
               if($upda)
              {
                  ...
                  session_destroy();
                    ...
                    echo "<script>alert('Vos mots de passes (Nouveau et de Confirmation) ne matchent pas.réessayer'); 
                    window.location='f_profile_edit.php'</script>";
                 }
              
            }

              echo "<script>alert('Vos mots de passes (Nouveau et de Confirmation) ne matchent pas'); 
                 window.location='f_profile_edit.php'</script>";
...
?>
  ...
  <a onclick="window.location.href='f_account_delete.php';" class="w3-bar-item w3-button w3-block w3-theme w3-left-align w3-hover-red" href="#" data-target="#changepassword" data-toggle="modal">

  <i class="fa fa-lock fa-fw w3-margin-right"></i> Supprimer Le Compte</a>
   <div id="Demo2" class="w3-hide w3-container">
    <div class="w3-row-padding">
    </div>
    </div>
...
<div class="w3-col m7">
      ...
      <div class="w3-col m12">
        <div class="w3-card w3-round w3-white">
          <div class="w3-container w3-padding w3-grayscale">
            ...
            <br>
            <h3 class="w3-opacity"><i class="fa fa fa-pencil"></i> Modifier Le Profile</h3>
            <br>
           
            <form method="post" action="f_profile_edit.php" class="w3-container w3-card-4 w3-light-grey">
            <br>
  ...
  {              
    ...
    $up ="UPDATE formateur_signup SET firstname='$_POST[first_name]',lastname='$_POST[last_name]',phone='$_POST[phone]',
...
?>
  ...
  <button onclick="window.location.href='f_logout.php';" class="w3-button w3-block w3-theme w3-left-align w3-hover-red"> 
  <i class="fa fa-info fa-fw w3-margin-right"></i>Déconnexion</button>
  <br />
