...
<div class="w3-row">
  ...
  <div class="w3-col m3">
    ...
    <div class="w3-card w3-round w3-white">
      ...
      <hr>
       <h4 class="w3-center bold text-shadow: 2px 2px #FF0000" style="color:black" ;>MON PROFILE : CLIENT</h4> 
       <hr></hr>
...
?>  
    ...
    <div class="w3-card w3-round">
      ...
      <div class="w3-white">
       ...
       <p><i class="fa fa fa-registered fa-fw w3-margin-right w3-large w3-text-teal"></i>Date D'Insription : 
      ...
      <button onclick="window.location.href='c_profile_edit.php';" class="w3-button w3-block w3-theme w3-left-align w3-hover-white">
...
if (isset($_POST['done'])) 
{
 ...
 if (empty($Type)) 
   ...
   if (!isset($errors)) 
  {
      ...
      $sql = 'INSERT INTO content (b_username,b_name,b_email,b_phone,category,type,content_name,est_price,quantity,cont_details,de_place) VALUES (?,?,?,?,?,?,?,?,?,?,?)';
  ...
  echo "<script type='text/javascript'> alert(".json_encode($use).") </script>";
...
?>
  ...
  <button onclick="window.location.href='c_search.php';" class="w3-button w3-block w3-theme-l1 w3-left-align w3-hover-green"> 
    ...
    <button onclick="window.location.href='c_my_comment.php';" class="w3-button w3-block w3-theme w3-left-align w3-hover-green"> 
    <i class="fa fa-comment fa-fw w3-margin-right"></i>MES COMMENTAIRES</button>
         
    <button onclick="window.location.href='c_chat_to_admin.php';" class="w3-button w3-block w3-theme w3-left-align w3-hover-green"> 
