...
<body>
  ...
  <div class="c11 container">
    <div class="row">
      ...
      <div class="card" id="Registration">
        <h5 class="card-header" class="py-5 text-center font-weight-bold"> <b>Inscription : Client </b></h5>
  ...
  <?php
       ...
       if(isset($_POST['submit']))
     {
        ...
        $signup_table = "INSERT INTO client_signup(firstname,lastname,username,phone,email,password)
               ...
               if(empty($fname) || empty($lname) || empty($uname) || empty($pass) || empty($phone) || empty($email) )
              {
                 ...
                 else
                {
                  ...
                  echo "<script>
                  alert('Felicitation ! Inscription avec Succes');  
                  </script>";
