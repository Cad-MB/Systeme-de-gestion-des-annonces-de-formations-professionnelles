...
<head>
 ...
 #formateur_profile  td, #formateur_profile  th 
 {
...
#formateur_profile  tr:nth-child(even){background-color: #f2f2f2;}

#formateur_profile  tr:hover {background-color: #ddd;}

#formateur_profile  th {
  padding-top: 12px;
  padding-bottom: 12px;
  text-align: center;
  font-size : 18px;
...
<!----------------  Start Header  ---------------->
  ...
  ?>
   ...
   <form method="post" action="admin_view_formateur_candidat.php" align="center">
             ...
             if(isset($_SESSION['user_name']))
            {
                ...
                echo "
                 <tr>
                  ...
                  <form method='post' action='admin_view_formateur_candidat.php'>
    ...
    <?php
      ...
      if (isset($_POST['Acceptation'])) 
     {
      ...
      $s_id = $_POST ['in_id'] ;
       ...
       $sql = "UPDATE formateur_signup SET state = 'Acceptation' WHERE signup_id= '$s_id'";

      if (mysqli_query($conn, $sql))
    {   
      echo "<script>alert('etat mis a jours avec succes'); 
      window.location='admin_view_formateur_candidat.php'</script>";
       mysqli_close($conn);
  ...
  window.location='admin_view_formateur_candidat.php'</script>";
   ...
   else if (isset($_POST['Refus'])) 
   {
    ...
    $s_id = $_POST ['in_id'] ;
     ...
     $sql = "UPDATE formateur_signup SET state = 'Refus' WHERE signup_id='$s_id' ";
...
window.location='admin_view_formateur_candidat.php'</script>";
 ...
 else if (isset($_POST['En cours'])) 
   {
    ...
    $s_id = $_POST ['in_id'] ;
     ...
     $sql = "UPDATE formateur_signup SET state = 'En cours' WHERE signup_id='$s_id' ";
