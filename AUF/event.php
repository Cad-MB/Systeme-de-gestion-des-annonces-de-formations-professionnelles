...
<!----------------  Start Header  ---------------->
      ...
      <div class="container">
        <div class="row">
            ...
            <aside class="left-sidebar">
              ...
              <div class="widget">
                ...
                <div class="video-container">
                  <iframe width="853" height="480" src="https://www.youtube.com/embed/watch?v=e7BIcrKhaJk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> </div>
              </div>
              ...
              <div class="widget">
                ...
                <p>
                La vie universitaire consiste à stimuler les petites cellules grises du cerveau…nos events sont l’occasion parfaite d’affiner vos compétences en toute sortes de domaines !
                </p>
          ...
          <div class="span8">
            ...
            <div class="row">
              <div class="span8">
                <h4 class="title"><strong>Evénements</strong></h4>
  ...
  // AND content.Active = 1
          ...
          $sql = "SELECT * FROM content,content_images 
            WHERE content.b_content_id = content_images.content_id AND content.category='Event'
           ...
           if ($result = mysqli_query($conn, $sql)) 
          {
               while ($row = mysqli_fetch_assoc($result)) 
              {
                ...
                <div id="pagination">
                  ...
                  <a href="event.php" class="inactive">2</a>
