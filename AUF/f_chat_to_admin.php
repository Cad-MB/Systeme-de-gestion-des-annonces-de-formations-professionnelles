...
$use = $_SESSION['user_name'];
  ...
  if(isset($_POST['done'])) 
 {
    ...
    $msg = $_POST['msg'];
     ...
     $sql = "INSERT INTO chat (name,subject,msg,role) VALUES ('$use','$sub','$msg','formateur') LIMIT 1 "; 
     ...
     echo "<script>alert('Message envoye a Admin avec Succes'); 
      window.location='f_chat_to_admin.php'</script>";
...
?>
  ...
  <form method="post" action="f_chat_to_admin.php" align="center">
